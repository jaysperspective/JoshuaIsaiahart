        ...
        <div className="flex gap-8 max-w-7xl mx-auto">
          ...
          <div className="w-80 flex-shrink-0">
            <div className="bg-[#fafafa] rounded-[20px] p-6">
              ...
              {/* Title input */}
              <div className="mb-4">
                <label className="font-body text-sm text-gray-600 block mb-1">
                  Title
                </label>
                <input
                  type="text"
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg font-body text-sm resize-none"
                  rows={3}
              ...
              {editingGallery ? (
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-[#1a1a1a] text-white py-2 rounded-lg font-body text-sm hover:bg-[#333] transition-colors"
                  >
                    Save Changes
                  </button>
                  <button
                    onClick={() => setEditingGallery(null)}
                    className="flex-1 bg-gray-200 text-gray-700 py-2 rounded-lg font-body text-sm hover:bg-gray-300 transition-colors"
                  >
                    Cancel
                  </button>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#1a1a1a] text-white py-2 rounded-lg font-body text-sm hover:bg-[#333] transition-colors disabled:opacity-50"
                >
          ...
          <div className="flex-1">
            <div className="bg-[#fafafa] rounded-[20px] p-6">
              <h2 className="font-heading text-xl font-bold mb-6">Galleries</h2>
